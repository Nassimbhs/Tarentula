 ...
 */
final class Version20210329212036 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profil CHANGE id id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profil CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
